    ...
    $.ajax(
        {
            ...
            success: function(result) {
                ...
                for (var i = 0;i<members.length;i++) {
                    $('#allMembersContainer').append('<div class="member-container"><div class="basic-details"><img src="images/member.png" class="member-image"><h3 class="member-name">'+members[i].name+'</h3></div><div class="inner-details"><div class="social-info"><span><a href="https://www.linkedin.com/in/gautham-kumar" target="_blank"><i id="linkedinLogo" class="fab fa-linkedin-in textLogo"></i></a></span><span><a href="https://www.github.com/gauthamk97" target="_blank"><i id="githubLogo" class="fab fa-github textLogo"></i></a></span></div></div></div>');
                }
